...
function getCryptoUpdate() {
	...
	cryptoUpdateXhr.open('GET', 'https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&order=market_cap_desc&per_page=4&page=1&sparkline=false', true);
	...
	cryptoUpdateXhr.onreadystatechange = function() {
		if (this.readyState == 4 && this.status == 200) {
			...
			cryptoValues.unshift({ name: 'Dollar', symbol: 'usd', price: 1, image: '/images/dollar.png' })
